	...
	return (
		<div className="wordsgain-playground-welcome">
			...
			<div className={ getElementClassName( 'wordsgain-playground', 'buttons' ) }>
				<Button handleButtonClick={ props.handleButtonClick } data={ { mode: 'predefined', numberOfWords: 10 } } color="green" width='half'>{ __( '10 Words', 'wordsgain' ) }</Button>
				<Button handleButtonClick={ props.handleButtonClick } data={ { mode: 'predefined', numberOfWords: 20 } } color="green" width='half'>{ __( '20 Words', 'wordsgain' ) }</Button>
			</div>
			<div className={ getElementClassName( 'wordsgain-playground', 'buttons' ) }>
			...
			<div className={ getElementClassName( 'wordsgain-playground', 'buttons' ) }>
				<Button handleButtonClick={ props.handleButtonClick } data={ { mode: 'predefined', numberOfWords: 100 } } color="gray" width='wide'>{ __( '100 Words', 'wordsgain' ) }</Button>
